...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Event.presentation_thumb'
        db.alter_column(u'events_event', 'presentation_thumb', self.gf('django.db.models.fields.files.ImageField')(max_length=150, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Event.presentation_thumb'
        raise RuntimeError("Cannot reverse this migration. 'Event.presentation_thumb' and its values cannot be restored.")
    ...
    models = {
        ...
        u'events.event': {
            ...
            'presentation_thumb': ('django.db.models.fields.files.ImageField', [], {'max_length': '150', 'null': 'True', 'blank': 'True'}),
